...
ipcMain.handle('deliveries:recordPOD', async (_evt, { userId, orderId, payload }) => data.deliveryOrdersRecordPOD(userId, orderId, payload));
ipcMain.handle('sales:closeShort', async (_evt, { userId, soId }) => data.salesCloseShort(userId, soId));
